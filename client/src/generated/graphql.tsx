...
export type PostUnionMutationResponse =
...
export type UserUnionMutationResponse =
    | ErrorMutationResponse
...
type CommonState_ErrorMutationResponse_Fragment = {
    __typename?: "ErrorMutationResponse";
    code: number;
    success: boolean;
    message?: string | null;
...
type CommonState_PostMutationResponse_Fragment = {
    __typename?: "PostMutationResponse";
    code: number;
    success: boolean;
    message?: string | null;
...
type CommonState_UserMutationResponse_Fragment = {
    __typename?: "UserMutationResponse";
    code: number;
    success: boolean;
    message?: string | null;
...
export type CommonStateFragment =
    | CommonState_ErrorMutationResponse_Fragment
    | CommonState_PostMutationResponse_Fragment
    | CommonState_UserMutationResponse_Fragment;
...
type PostUnionMutationResponse_ErrorMutationResponse_Fragment = {
    __typename?: "ErrorMutationResponse";
    code: number;
    success: boolean;
    message?: string | null;
...
export type PostUnionMutationResponseFragment =
    | PostUnionMutationResponse_ErrorMutationResponse_Fragment
    | PostUnionMutationResponse_PostMutationResponse_Fragment;
...
export type UserLogedInVotedFragment = {
    __typename?: "Post";
    userLogedInVoted: number;
};

export type UserLogedInVotedAndPointsFragment = {
    __typename?: "Post";
    userLogedInVoted: number;
    points: number;
};

type UserUnionMutationResponse_ErrorMutationResponse_Fragment = {
    __typename?: "ErrorMutationResponse";
    code: number;
    success: boolean;
    message?: string | null;
...
type UserUnionMutationResponse_UserMutationResponse_Fragment = {
    __typename?: "UserMutationResponse";
    code: number;
    success: boolean;
    message?: string | null;
...
export type UserUnionMutationResponseFragment =
    | UserUnionMutationResponse_ErrorMutationResponse_Fragment
    | UserUnionMutationResponse_UserMutationResponse_Fragment;
 ...
 * });
 */
export function useLoginProfileQuery(
    baseOptions?: Apollo.QueryHookOptions<
        LoginProfileQuery,
        LoginProfileQueryVariables
    >
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<LoginProfileQuery, LoginProfileQueryVariables>(
        LoginProfileDocument,
        options
    );
}
export function useLoginProfileLazyQuery(
    ...
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useLazyQuery<LoginProfileQuery, LoginProfileQueryVariables>(
        LoginProfileDocument,
        options
    );
}
export type LoginProfileQueryHookResult = ReturnType<
    typeof useLoginProfileQuery
>;
export type LoginProfileLazyQueryHookResult = ReturnType<
    typeof useLoginProfileLazyQuery
>;
export type LoginProfileQueryResult = Apollo.QueryResult<
    LoginProfileQuery,
    LoginProfileQueryVariables
>;
